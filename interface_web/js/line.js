                            ...
                            $.getJSON(urlLine, function(data){
                                ...
                                for(i=0;i<data.length;i++){ 
                                    ...
                                    if(v){
                                      ...
                                      // alert(chart.series[save].data.length);
                                        for(x=chart.series[save].data.length;x<data[i].data.length;x++){
                                            chart.series[save].addPoint(data[i].data[x]);
                                        }
                                        //alert('b');
                                       // alert(_.union(chart.series[save].data,data[data][i]));
                                        //chart.series[save].data=_.union(chart.series[save].data,data[data][i]);
                                    }
                                //alert(data[0]['data'][0]);
