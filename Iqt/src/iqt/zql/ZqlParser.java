...
public class ZqlParser {
   ...
   */
  public static void main(String args[]) throws ParseException, br.com.iqt.zql.ParseException {
   ...
   */
  public ZStatement readStatement() throws ParseException, br.com.iqt.zql.ParseException {
    if(_parser == null)
      throw new ParseException(
       "Parser not initialized: use initParser(InputStream);",2);
   ...
   */
  public Vector readStatements() throws ParseException, br.com.iqt.zql.ParseException {
    if(_parser == null)
      throw new ParseException(
       "Parser not initialized: use initParser(InputStream);",2);
   ...
   */
  public ZExp readExpression() throws ParseException, br.com.iqt.zql.ParseException {
    if(_parser == null)
      throw new ParseException(
       "Parser not initialized: use initParser(InputStream);",2);
